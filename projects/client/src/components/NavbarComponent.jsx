...
export default function Navbar(props) {
  ...
  return (
    <div className={`border-b border-slate-400 ${props.class} ${pathName === '/' || pathName === '/transaction_list'  || pathName === '/prescription' || pathName === '/profile' || pathName === '/product' || pathName === '/cart'  || pathName === '/checkout'|| pathName === '/login' || pathName === '/register' ? '' : 'hidden'} ${pathName === '/login' || pathName === '/register' ? 'absolute w-full' : ""}`}>
